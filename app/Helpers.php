    ...
    function aside_menu()
    {
        return [
            [
                ...
                'show' => Auth::user()->is_admin || in_array('users.index', Auth::user()->role ? Auth::user()->role->user_access : []) || in_array('role.index', Auth::user()->role ? Auth::user()->role->user_access : []),
                'children' => [
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('users.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('role.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                ]
            ],
            [
                ...
                'show' => Auth::user()->is_admin || in_array('commission.index', Auth::user()->role ? Auth::user()->role->user_access : []) || in_array('main-coordinator.index', Auth::user()->role ? Auth::user()->role->user_access : []) || in_array('regional-coordinator.index', Auth::user()->role ? Auth::user()->role->user_access : []) || in_array('agencies.index', Auth::user()->role ? Auth::user()->role->user_access : []) || in_array('sales.index', Auth::user()->role ? Auth::user()->role->user_access : []),
                'children' => [
                    ...
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('commission.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('main-coordinator.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('regional-coordinator.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                    [
                        'icon' => 'mdi-contacts',
                        'text' => 'Sub Agent',
                        ...
                        'show' => Auth::user()->is_admin || in_array('agencies.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('sales.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                ],
            ],
            [
                ...
                'show' => Auth::user()->is_admin || in_array('reward-category.index', Auth::user()->role ? Auth::user()->role->user_access : []) || in_array('reward-point.index', Auth::user()->role ? Auth::user()->role->user_access : []),
                'children' => [
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('reward-category.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('reward-point.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                ]
            ],
            [
                ...
                'show' => Auth::user()->is_admin || in_array('tipe-program.index', Auth::user()->role ? Auth::user()->role->user_access : []) || in_array('point.index', Auth::user()->role ? Auth::user()->role->user_access : []) || in_array('client.index', Auth::user()->role ? Auth::user()->role->user_access : []) || in_array('booking.index', Auth::user()->role ? Auth::user()->role->user_access : []) || in_array('installment.index', Auth::user()->role ? Auth::user()->role->user_access : []) || in_array('cancel-booking.index', Auth::user()->role ? Auth::user()->role->user_access : []),
                'children' => [
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('tipe-program.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                    [
                    ...
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('point.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                    [
                        'icon' => 'mdi-account-multiple',
                        'text' => 'Klien',
                        ...
                        'show' => Auth::user()->is_admin || in_array('client.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('booking.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('installment.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('cancel-booking.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                ]           
            ],
            [
                ...
                'show' => Auth::user()->is_admin || in_array('document.index', Auth::user()->role ? Auth::user()->role->user_access : []) || in_array('document-admin.index', Auth::user()->role ? Auth::user()->role->user_access : []),
                'children' => [
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('document.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ],
                    [
                        ...
                        'show' => Auth::user()->is_admin || in_array('document-admin.index', Auth::user()->role ? Auth::user()->role->user_access : [])
                    ]
                ]           
            ],
            [  
                ...
                'show' => Auth::user()->is_admin || in_array('spr.index', Auth::user()->role ? Auth::user()->role->user_access : [])
            ],
            [
                'icon' => 'mdi-buffer',
                'icon-alt' => 'mdi-chevron-down',
                ...
                'show' => Auth::user()->is_admin || in_array('PPJB.index', Auth::user()->role ? Auth::user()->role->user_access : [])
            ],
            [
            ...
            [
                ...
                'show' => Auth::user()->is_admin || in_array('akad.index', Auth::user()->role ? Auth::user()->role->user_access : [])
            ],
            [
                'icon' => 'mdi-book',
                'icon-alt' => 'mdi-chevron-down',
                ...
                'show' => Auth::user()->is_admin || in_array('ajb.index', Auth::user()->role ? Auth::user()->role->user_access : [])
            ],
            [
                'icon' => 'mdi-handshake',
                'icon-alt' => 'mdi-chevron-down',
                ...
                'show' => Auth::user()->is_admin || in_array('handover.index', Auth::user()->role ? Auth::user()->role->user_access : [])
            ],
            [
                'icon' => 'mdi-sale',
                'icon-alt' => 'mdi-chevron-down',
            ...
            [
                ...
                'show' => Auth::user()->is_admin || in_array('tukar-point.index', Auth::user()->role ? Auth::user()->role->user_access : [])
            ],
            [
                'icon' => 'mdi-file-chart',
                'icon-alt' => 'mdi-chevron-down',
