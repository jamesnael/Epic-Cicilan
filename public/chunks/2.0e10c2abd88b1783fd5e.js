      ...
      if (this.dataUri) {
        ...
        axios.get(this.dataUri).then(function (response) {
          if (response.data.success) {
            ...
            _this.form_data = (_this$form_data = {
              category_name: data.category_name,
              description: data.description,
              category_reward_id: data.category_name,
              reward_name: data.reward_name,
              redeem_point: data.redeem_point,
              kuota: data.kuota
            }, _defineProperty(_this$form_data, "description", data.description), _defineProperty(_this$form_data, "status", data.status), _this$form_data);
