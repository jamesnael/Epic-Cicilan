  ...
  methods: {
    submit: function submit() {
      this.$refs.observer.validate().then(function (success) {
        if (!success) {
          return;
        } // this.perkuliahanLoader = val == 'Perkuliahan' ? true : false
        // this.UTSLoader = val == 'Ujian Tengah Semester' ? true : false
        // this.UASLoader = val == 'Ujian Akhir Semester' ? true : false
        //       this.submitForm();
