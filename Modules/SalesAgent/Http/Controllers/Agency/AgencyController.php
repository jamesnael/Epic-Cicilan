...
class AgencyController extends Controller
{
    ...
    public function getHelper()
    {
        return [
            ...
            'agency_commission' => Commission::select('id AS value', 'commission_type AS text','sales_commission','agency_commission','main_coordinator_commission', 'regional_coordinator_commission','agency_commission')->get(),
