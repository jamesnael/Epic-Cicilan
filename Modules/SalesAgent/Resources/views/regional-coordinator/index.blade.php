...
@section('content')
	...
	<table-layout inline-template
		uri="{{ route('regional-coordinator.table') }}"
		...
		page-text-locale="id"
		add-new-uri="{{ route('regional-coordinator.create') }}"
		add-new-text="Tambah"
		add-new-color="light-blue lighten-2"
		edit-uri="regional-coordinator.edit"
		edit-uri-parameter="slug"
		edit-text="Ubah"
		delete-uri="regional-coordinator.destroy"
