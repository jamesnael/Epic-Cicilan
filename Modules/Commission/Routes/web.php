...
Route::group(['namespace' => 'Sales'], function() {
	...
	Route::get('komisi-sales/table/koordinator-wilayah', 'SalesCommissionController@tableKorwil')->name('salescommission.table.korwil');
	Route::get('komisi-sales/table/koordinator-utama', 'SalesCommissionController@tableKorut')->name('salescommission.table.korut');
	...
	Route::get('komisi-sales/{salescommission}/ubah-koordinator-wilayah', 'SalesCommissionController@editKorwil')->name('salescommission.edit.korwil');
	Route::get('komisi-sales/{salescommission}/ubah-koordinator-utama', 'SalesCommissionController@editKorut')->name('salescommission.edit.korut');
